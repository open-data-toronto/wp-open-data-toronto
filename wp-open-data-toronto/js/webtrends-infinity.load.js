...
window.webtrendsAsyncInit = function () {
  var dcs = new Webtrends.dcs()
    .init({
      ...
      download: false,
      downloadtypes:
        "avi,csv,doc,docm,docx,flv,gzip,ics,json,m4a,mp3,mp4,pdf,ppt,pptm,pptx,rar,swf,txt,wmv,xls,xlsm,xlsx,xml,xsd,zip,geojson",
      anchor: false,
      javascript: false,
      metanames: "DC.title",
      preserve: false,
      ...
      plugins: {
        ...
        scroll_depth: {
          src: "https://www.toronto.ca/scripts/webtrends.scroll_depth.js",
        },
        torontolinktrack: {
          src: "https://www.toronto.ca/scripts/toronto.linktrack.js",
          download: true,
          anchor: true,
          javascript: true,
          email: true,
