    ...
    <div class="row">
      <div class="col-md-12">
        <nav class="breadcrumb" aria-label="breadcrumbs">
          <a class="breadcrumb-item" href="<?php echo site_url(); ?>"
            >Open Data Portal Home</a
          >
          <a class="breadcrumb-item" href="<?php echo site_url(); ?>/catalogue/"
            >Open Data Catalogue</a
          >
          <a class="breadcrumb-item" data-field="title"
            ><?php the_title(); ?></a
          >
        </nav>
      </div>
              ...
              <dl>
                ...
                <dd>
                  <a
                    ...
                    class="inline-link"
                    >Open Government License - Toronto</a
                  >
                </dd>
              </dl>
            </div>
                ...
                <div class="accordion">
                  <div class="card accordion__section">
                    ...
                    <div
                      ...
                      id="body-dataPreview"
                      class="collapse"
                      aria-labelledby="header-dataPreview"
                  ...
                  <div class="card accordion__section">
                    ...
                    <div
                      ...
                      id="body-Download"
                      class="collapse"
                      aria-labelledby="header-Download"
                      data-parent="#js-accordion__su9l98td5"
                    >
                      <div class="card-body accordion__body">
                  ...
                  <div class="card accordion__section">
                    ...
                    <div
                      ...
                      id="body-Explore"
                      class="collapse"
                      aria-labelledby="header-Explore"
                      data-parent="#js-accordion__su9l98td5"
                    >
                      <div class="card-body accordion__body">
                        <div class="row explore-line" id="explore-ckan">
                          ...
                          <div class="col-md-7">
                            ...
                            <p>
                              Want to explore this data without having to
                              download it? Try it here
                            </p>
                          </div>
                  ...
                  <div class="card accordion__section">
                    ...
                    <div
                      ...
                      id="body-Developers"
                      class="collapse"
                      aria-labelledby="header-Developers"
                      data-parent="#js-accordion__su9l98td5"
                    >
                      <div class="card-body accordion__body">
                        <div class="card-block">
                          <div class="row">
                            <div class="col-md-12">
                              <p>
                                Below are sample code snippets for accessing a
                                dataset via the API. Refer to the
                                <a
                                  href="http://docs.ckan.org/en/latest/api/index.html"
                                  target="_blank"
                                  >CKAN API documentation</a
                                >
