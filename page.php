...
.hide-full-length{display: none !important;}
.show-full-length{width: 100%; flex: 0 0 100%; max-width: 100%;}
#toc_container {
    background: #ffffff;
...
<section class="content-area">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="banner" style="background-image:url(<?php $url = wp_get_attachment_url( get_post_thumbnail_id($post->ID), 'thumbnail' ); ?><?php echo $url ?>") !important">
