...
function wp_bootstrap_starter_scripts() {
    ...
    if(get_theme_mod( 'preset_style_setting' ) === 'preset1') {
        wp_enqueue_style( 'wp-bootstrap-starter-preset1-font', 'https://fonts.googleapis.com/css?family=Lora:400,400i,700,700i|Poppins:300,400,500,600,700' );
    }
    if(get_theme_mod( 'preset_style_setting' ) === 'preset2') {
        wp_enqueue_style( 'wp-bootstrap-starter-preset2-font', 'https://fonts.googleapis.com/css?family=Merriweather:300,400,400i,700,900|Montserrat:300,400,400i,500,700,800' );
    }
    if(get_theme_mod( 'preset_style_setting' ) && get_theme_mod( 'preset_style_setting' ) !== 'default') {
        wp_enqueue_style( 'wp-bootstrap-starter-'.get_theme_mod( 'preset_style_setting' ), get_template_directory_uri() . '/css/'.get_theme_mod( 'preset_style_setting' ).'.css', false, '' );
    }
